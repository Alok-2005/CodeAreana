...
const CodeArena = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
      {/* Navbar */}
      <nav className="fixed w-full py-4 z-50 bg-gray-900 bg-opacity-90 backdrop-blur-sm border-b border-gray-800">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8">
            {['Home', 'About', 'Schedule', 'Prizes', 'Register'].map((item) => (
              <a 
                key={item}
      ...
      <section 
        ...
        style={{
          background: 'radial-gradient(circle at top right, rgba(67, 56, 202, 0.15) 0%, transparent 30%), radial-gradient(circle at bottom left, rgba(124, 58, 237, 0.15) 0%, transparent 30%)'
        }}
      >
        <div className="floating-bg absolute inset-0 z-0" style={{
          background: 'radial-gradient(circle at 20% 30%, rgba(99, 102, 241, 0.08) 0%, transparent 40%), radial-gradient(circle at 80% 70%, rgba(139, 92, 246, 0.08) 0%, transparent 40%)'
        }}></div>
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block px-4 py-1 mb-6 bg-gray-800 rounded-full border border-gray-700">
              <span className="text-indigo-400 font-medium">Hackathon Season</span>
            </div>
            
            <h1 className="hero-title text-5xl md:text-7xl font-extrabold mb-6">
              <span className="block">Code</span>
              <span className="block bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-400">Arena 3.0</span>
            </h1>
            
            <h2 className="hero-subtitle text-2xl md:text-3xl font-bold mb-6 text-gray-300">
              The Ultimate AI Healthcare Coding Showdown
            </h2>
            
            <p className="hero-desc text-xl mb-10 text-gray-300 max-w-2xl mx-auto">
              Compete, innovate, and revolutionize healthcare with AI. Join us for a 24-hour hackathon where brilliant minds create solutions that matter.
            </p>
            
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a 
                href="#register" 
                className="hero-btn inline-block px-8 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg font-bold text-lg shadow-lg hover:shadow-xl transition-all hover:scale-[1.03]"
              >
                Register Now
              </a>
              <a 
                href="#schedule" 
                className="hero-btn inline-block px-8 py-4 bg-gray-800 rounded-lg font-bold text-lg border border-gray-700 hover:bg-gray-750 transition-colors"
              >
                View Schedule
              </a>
            </div>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              { title: "24 Hours", desc: "Intense coding marathon" },
              { title: "AI + Health", desc: "Theme focus area" },
              { title: "$10K+ Prizes", desc: "Winning rewards" },
              { title: "Global Talent", desc: "Meet the best coders" }
            ].map((item, i) => (
              <div 
                key={i} 
                className="floating-item bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl p-6 border border-gray-700"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              About <span className="text-indigo-400">CodeArena 3.0</span>
            </h2>
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            <p className="text-xl text-gray-300 mb-8">
              CodeArena 3.0 is a premier campus hackathon organized by <span className="text-purple-400 font-medium">CodeCraft</span> in collaboration with <span className="text-pink-400 font-medium">ACM-W</span>. 
              This intensive one-day event challenges student teams to build AI-driven healthcare solutions that can make a real difference.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Undergraduate students from all disciplines (teams of 2–4)"
                },
                {
                  icon: "⏱️",
                  title: "Duration",
                  desc: "One day — intense & fun. September 28, 2025"
                },
                {
                  icon: "💻",
                  title: "Format",
                  desc: "Build → Demo → Pitch → Winners announced same day"
                }
              ].map((item, i) => (
                <div 
                  key={i} 
                  className="about-card bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-indigo-500 transition-all"
                >
          ...
          <div className="max-w-5xl mx-auto bg-gradient-to-r from-gray-800 to-gray-850 rounded-2xl p-8 border border-gray-700">
            <h3 className="text-2xl font-bold mb-6 text-center">Healthcare Focus Areas</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                "AI diagnostic tools & imaging analysis",
                "Patient care automation & virtual assistants",
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-purple-900 to-indigo-900 rounded-2xl p-8 border border-purple-700">
              <h3 className="text-2xl font-bold mb-4 text-center">Special Category Awards</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  "Most Innovative Solution",
                  "Best Healthcare Impact",
                  "Best AI Implementation",
                  "Best UI/UX Design",
                  "Best Pitch Presentation",
                  "People's Choice Award"
                ].map((award, i) => (
                  <div key={i} className="flex items-center p-3 bg-indigo-900 bg-opacity-30 rounded-lg">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-indigo-500 mx-auto rounded-full"></div>
            <p className="text-xl text-gray-400 mt-6 max-w-2xl mx-auto">
              Form your team (2-4 members), pick a problem statement, and register today.
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-8 md:mb-0">
              <div className="flex items-center space-x-2 mb-4">
                <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-1 rounded-lg">
                  <div className="bg-gray-900 p-1 rounded">
                    <div className="w-8 h-8 rounded bg-gradient-to-r from-purple-500 to-indigo-500"></div>
                  </div>
                </div>
                <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-400">
                  CodeCraft
